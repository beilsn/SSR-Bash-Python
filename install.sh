...
git clone https://github.com/beilsn/SSR-Bash-Python.git
...
wget -N --no-check-certificate -O /usr/local/bin/ssr https://raw.githubusercontent.com/beilsn/SSR-Bash-Python/master/ssr
